...
import src.main.java.ru.geekbrains.java2.chat.client.controller.Network;
...
public class ServerMessageService implements ru.geekbrains.java2.chat.client.controller.message.IMessageService {
    ...
    private void startConnectionToServer() {
        try {
            ...
            throw new ru.geekbrains.java2.chat.client.controller.message.ServerConnectionException("Failed to connect to server", e);
        }
    }
